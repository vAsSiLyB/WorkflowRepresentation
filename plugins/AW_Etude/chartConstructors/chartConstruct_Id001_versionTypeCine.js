statisticsChart.requestCache['Id001_versionTypeCine'].initiator = function() {
	// Histo
	var histoData = {
			id : "repartVersions",
			ord : {
			...
			switch (version.label) {
				...
				case 'VA-STMA' :
					if (typeof STMAu[codeCase] === 'undefined') {
						...
						STMAu[codeCase].infoBox = em.codeCaseDiff + ' / ' + em.nomCaseDiff;
					}
				...
				case 'VF-STMF' : 
					if (typeof STMFu[codeCase] === 'undefined') {
						...
						STMFu[codeCase].infoBox = em.codeCaseDiff + ' / ' + em.nomCaseDiff;
					}
				...
				case 'VAAUD' :
					if (typeof AUDAu[codeCase] === 'undefined') {
						...
						AUDAu[codeCase].infoBox = em.codeCaseDiff + ' / ' + em.nomCaseDiff;
					}
				...
				case 'VFAUD' :
					if (typeof AUDFu[codeCase] === 'undefined') {
						...
						AUDFu[codeCase].infoBox = em.codeCaseDiff + ' / ' + em.nomCaseDiff;
					}
				...
				case 'VO-STA' : 
					if (typeof VOu[codeCase] === 'undefined') {
						...
						VOu[codeCase].infoBox = em.codeCaseDiff + ' / ' + em.nomCaseDiff;
					}
				case 'VO-STF' :
					if (version.etat !== 'Q')
						needToCheckVF = true;
