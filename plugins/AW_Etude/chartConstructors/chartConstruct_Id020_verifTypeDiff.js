statisticsChart.requestCache['Id020_verifTypeDiff'].initiator = function() {
	// Histo
	var histoData = {
			id : "verifTypes",
			ord : {
			...
			graphDef : {
				type : "xy",
				subType : "histoMulti",
				title : "Répartition des vérifications de versions",
				subTitle : "Versions diffusées sur une période de 12 mois",
