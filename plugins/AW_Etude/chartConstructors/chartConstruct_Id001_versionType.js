statisticsChart.requestCache['Id001_versionType'].initiator = function() {
	// Histo
	var histoData = {
			id : "repartVersions",
			ord : {
			...
			graphDef : {
				type : "xy",
				subType : "histoMulti",
				title : "Typologie des versions secondaires, réparties par unité de programmes",
...
//	var baseData = JSON.parse(data);
			...
			switch (version.label) {
				...
				case 'VA-STMA' :
					if (typeof STMAu[codeCase] === 'undefined') {
						...
						STMAu[codeCase].infoBox = codeCase + ' : ' + em.nomCaseDiff;
					}
				...
				case 'VF-STMF' : 
					if (typeof STMFu[codeCase] === 'undefined') {
						...
						STMFu[codeCase].infoBox = codeCase + ' : ' + em.nomCaseDiff;
					}
				...
				case 'VAAUD' :
					if (typeof AUDAu[codeCase] === 'undefined') {
						...
						AUDAu[codeCase].infoBox = codeCase + ' : ' + em.nomCaseDiff;
					}
				...
				case 'VFAUD' :
					if (typeof AUDFu[codeCase] === 'undefined') {
						...
						AUDFu[codeCase].infoBox = codeCase + ' : ' + em.nomCaseDiff;
					}
				...
				case 'VO-STA' : 
					if (typeof VOu[codeCase] === 'undefined') {
						...
						VOu[codeCase].infoBox = codeCase + ' : ' + em.nomCaseDiff;
					}
				case 'VO-STF' :
					if (version.etat !== 'Q')
						needToCheckVF = true;
	...
	console.log(testSum, testSumMal);
